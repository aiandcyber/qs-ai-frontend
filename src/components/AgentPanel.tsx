...
export default function AgentPanel({
  ...
  async function send(text: string) {
    ...
    // Enforce login only when the agent is actually used (protects LLM tokens).
    ...
    <aside className="agent-rail">
      ...
      <div className="agent-head">
        <div className="agent-headline">
          <span className="agent-title">{t(locale, 'agent_title')}</span>
          <span className="agent-sub">{t(locale, 'agent_sub')}</span>
        </div>
